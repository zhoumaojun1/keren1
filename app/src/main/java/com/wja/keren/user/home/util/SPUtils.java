...
public class SPUtils {
    ...
    public static int   SD_CARD_STATUS = -1;
     ...
     */
    public static <E>void put(@NonNull String key,@NonNull E value, boolean apply) {
        put(DemoApplication.getApplication(),key,value, apply);
    }
    ...
    public static <E>E get(@NonNull String key,@NonNull E defaultValue) {
        return get(DemoApplication.getApplication(),key,defaultValue);
     ...
     * @return
     */
    public static <E>void put(Context context,@NonNull String key,@NonNull E value, boolean apply) {
    ...
    public static boolean contains(String key) {
        return contains(DemoApplication.getApplication(),key);
    }
