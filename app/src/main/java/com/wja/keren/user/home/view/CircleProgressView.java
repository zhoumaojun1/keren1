...
public class CircleProgressView extends View {
    ...
    public CircleProgressView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mProgressWidth = (int) typedArray.getDimension(R.styleable.CircleProgressView_progressWidth1, mDefaultWidth);
        mProgressColor = (int) typedArray.getDimension(R.styleable.CircleProgressView_progressColor1, ContextCompat.getColor(getContext(), R.color.color_1FC8A9));
        mStartAngle = typedArray.getInt(R.styleable.CircleProgressView_startAngle1, 0);
        mEndAngle = typedArray.getInt(R.styleable.CircleProgressView_startAngle1, 360);
        mBackgroundColor = (int) typedArray.getDimension(R.styleable.CircleProgressView_backgroundColor1, ContextCompat.getColor(getContext(), R.color.white_full));
        mShowAnimation = typedArray.getBoolean(R.styleable.CircleProgressView_animation1, false);
        mDuration = typedArray.getInt(R.styleable.CircleProgressView_duration1, 2000);
        typedArray.recycle();
