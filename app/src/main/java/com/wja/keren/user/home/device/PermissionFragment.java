...
public class PermissionFragment extends BottomSheetDialogFragment {
    ...
    private static PermissionFragment.OnClickCloseDialog onDismissCallback;
    public static class InfoService {


        public void setOnClickCloseDialog(PermissionFragment.OnClickCloseDialog onDismissBack) {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        view = View.inflate(getContext(), R.layout.bottom_tab_permission, null);
       Button btnOpenBle = view.findViewById(R.id.btn_now_open_ble);
