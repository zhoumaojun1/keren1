...
public class HtlRetrofit {
    private static final String TAG = HtlRetrofit.class.getName();
    ...
    public static HtlRetrofit getInstance() {
    ...
    private static class Inner {
        private static HtlRetrofit api = new HtlRetrofit();
    ...
    private HtlRetrofit() {
        ...
        Interceptor timeoutInterceptor = chain -> {
            ...
            HttpUrl   newBaseUrl = HttpUrl.parse(WJA_LOGIN_ON_LINE_CARD_URL);
        ...
        OkHttpClient.Builder builder = new OkHttpClient.Builder()
            ...
            retrofit = new Retrofit.Builder()
                    .client(okHttpClient)
                    .baseUrl(WJA_LOGIN_ON_LINE_CARD_URL)
