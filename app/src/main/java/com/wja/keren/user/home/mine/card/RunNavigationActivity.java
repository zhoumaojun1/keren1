...
public class RunNavigationActivity extends BaseActivity<CardLocation.Presenter> implements CardLocation.View, LocationSource, AMapLocationListener {

    @BindView(R.id.mMapView)
    MapView mMapView ;

    @BindView(R.id.et_input_location)
    TextInputEditText etInputLocation ;
    ...
    private BitmapDescriptor carBitmap=
            BitmapDescriptorFactory.fromResource(R.mipmap.run_navigation_location);
